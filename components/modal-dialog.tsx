    ...
    setTimeout(() => {
      ...
      if (isWeather) {
        ...
        setSimulationResponse(
          JSON.stringify(
            {
              session_id: "KS-EVAL-PUN-882",
              farmer: "Ramu Yadav (Pune)",
              parcel_id: "MH-PUN-HAV-7/12-882 (2.5 Acres Sugarcane)",
              dialect: selectedLanguage,
              query_transcribed: queryText,
              root_zone_soil_moisture_pct: 38.0,
              moisture_status: "OPTIMAL (Sensor-backed: skip irrigation today)",
              rule_engine_icar: {
                engine: "calculateIcarFertilizer (TypeScript)",
                pop_registry: "MPKV Rahuri / VNMKV Package of Practices",
                chemical_dosages: "Computed by rule engine, never generated by LLM",
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div className="md:col-span-2 space-y-2">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {(isWeather
                      ? [
                          "आज रात बारिश होगी? (Will it rain tonight?)",
                          "गाँव में चेतावनी है? (Is there an alert in the village?)",
                          "यह बारिश सामान्य है? (Is this rain normal?)",
                        ]
                      : [
                          "उद्या फवारणी करू का? (Can I spray tomorrow?)",
                          "आता युरिया टाकू का? (Top-dress urea now?)",
                          "पाणी देऊ का? (Should I irrigate?)",
                        ]
                    ).map((prompt, i) => (
                      <button
                        key={i}
