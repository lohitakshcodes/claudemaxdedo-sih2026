...
export const BrokenChainFlowchart: React.FC<BrokenChainFlowchartProps> = ({ projectId }) => {
  ...
  const legacyNodes = isWeather
    ...
    : [
        ...
        {
          id: 4,
          badge: "Step 04 • Uncalibrated Hallucinations",
          title: "Generic 'Super-App' AI Failures",
          payload: "Generic LLM Wrapper / Conversational Data Dumping",
          status: "FAIL",
        ...
        {
          id: 5,
          badge: "Step 05 • Agrarian Decision Blindness",
          title: "Systemic Farmgate Advice Void",
          payload: "33.9M ha excess rain + 35M ha drought (2015–21)",
          status: "CRITICAL",
          issue: "NSS 77th round reports 57.8% of farm households received no technical advice, leading to 68.9M ha lost to rain/drought extremes.",
          metric: "68.9M Hectares Impacted",
          icon: TrendingDown,
        },
      ];
